...
const plans = [
  {
    ...
    description:
      'You want a simple way to track spending and income. Get started for free.',
    button: {
  ...
  },
  {
    ...
    description:
      'You want richer budgeting, recurring records, and clearer asset tracking.',
    button: {
      label: 'Subscribe',
      href: '#',
    },
  ...
  },
  {
    ...
    description:
      'You manage shared budgets and want everyone aligned around household spending.',
    button: {
      label: 'Subscribe',
      href: '#',
    },
    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            Simple pricing for simple money management.
          </h2>
          <p className="mt-2 text-lg text-gray-600">
            Start with the basics, then add richer budgets and shared finance
