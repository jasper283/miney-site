  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: '#2563eb', animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-xs/6 text-gray-500">Miney Balance</div>
            <div className="text-sm text-gray-900">June</div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            <div className="flex items-baseline gap-2">
              <div className="text-2xl tracking-tight text-gray-900 tabular-nums">
                {(activeValue * 24).toLocaleString('en-US', {
            ...
            <div className="mt-6 flex gap-4 text-xs text-gray-500">
              <div>Day</div>
              <div>Week</div>
              <div className="font-semibold text-cyan-600">Month</div>
              <div>Year</div>
            </div>
            ...
            <div className="mt-3 divide-y divide-gray-100 text-sm">
              <div className="flex justify-between py-1">
                ...
                <div className="font-medium text-gray-900">$6,387</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-gray-500">Expenses</div>
                <div className="font-medium text-gray-900">$3,487</div>
              </div>
              <div className="flex justify-between py-1">
                <div className="text-gray-500">Saved</div>
                <div className="font-medium text-gray-900">$2,900</div>
              </div>
            </div>
          </div>
        </div>
